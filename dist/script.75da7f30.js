...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/indi.jpg":[function(require,module,exports) {
module.exports = "/indi.5b60a335.jpg";
...
var _indi = _interopRequireDefault(require("./assets/indi.jpg"));
...
}), new _blocks.TextBlock('Здесь можно создать несколько элементов типа: Текст и заголовок', {
  styles: {
    color: '#52b2b2b',
    'font-size': "1,9em",
    'text-align': 'center',
...
}), new _blocks.ColumnsBlock(['Для того, чтобы создать что-то, заполните поля в левом верхнем углу', 'Вписывайте текст в поле "Текст/заголовок"', 'первая колонка - это содержимое. А вторая - это стили CSS, можно ввести к примеру: color: green;'], {
  styles: {
    color: '#ffebeb',
    background: 'linear-gradient(to right, #000ff0, #583700)',
    'text-align': 'center'
  }
}), new _blocks.ImageBlock(_indi.default, {
  styles: {},
  imageStyles: {
    width: '99%',
...
exports.model = model;
},{"./assets/indi.jpg":"assets/indi.jpg","./classes/blocks":"classes/blocks.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    key: "template",
    get: function get() {
      return [(0, _utils.block)('Текст'), (0, _utils.block)('Заголовок')].join('');
    }
  }, {
    key: "add",
...
exports.App = App;
},{"./site":"classes/site.js","./sidebar":"classes/sidebar.js"}],"script.js":[function(require,module,exports) {
"use strict";
